...
set_property PACKAGE_PIN R13 [get_ports {outValue[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {outValue[0]}]
set_property PACKAGE_PIN R12 [get_ports {outValue[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {outValue[1]}]
set_property PACKAGE_PIN R10 [get_ports {outValue[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {outValue[2]}]
set_property PACKAGE_PIN N12 [get_ports {checkSum}]
set_property IOSTANDARD LVCMOS33 [get_ports {checkSum}]
set_property PACKAGE_PIN P11 [get_ports {checkCarry}]
set_property IOSTANDARD LVCMOS33 [get_ports {checkCarry}]
